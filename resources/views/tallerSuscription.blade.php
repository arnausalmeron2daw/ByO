            ...
            <form class="formulario" action="{{ route('tallerSuscription.store') }}" method="POST">
                @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="card_number" name="card_number" class="border border-gray-300 rounded-md px-4 py-2 w-full" required>
                    </div>

                    <div class="mb-4">
                        <label for="expiry_date" class="block text-gray-700 font-semibold mb-2">Fecha de Caducidad:</label>
                        <input type="text" id="expiry_date" name="expiry_date" class="border border-gray-300 rounded-md px-4 py-2 w-full" placeholder="MM/AA" required>
                    </div>

                    <div class="mb-6">
                        <label for="cvc" class="block text-gray-700 font-semibold mb-2">CVC:</label>
                        <input type="text" id="cvc" name="cvc" class="border border-gray-300 rounded-md px-4 py-2 w-full" required>
                    </div>
                    <h2 class="text-1xl font-bold mb-6">Precio del servicio 29.99€/M</h2>

                    

                    <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition-colors">Registrarse y Pagar</button>        
            </form>
