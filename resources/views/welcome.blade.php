            ...
            <div class="relative pt-8">
                @if (Route::has('login'))
                    <nav class="flex justify-center flex-row gap-8 items-center">
                        ...
                        <a href="{{ route('registerUser.index') }}"
                            class="font-sans text-xl text-white hover:text-yellow-400">
                            Register
                        </a>
                    </nav>
                @endif
    ...
    <main class=" pt-64 pb-32">
        ...
        <div class="flex justify-around flex-row w-full pt-20 align-middle">
            <div class="flex pl-32 w-1/2 text-left flex-col gap-16">
                ...
                <p>
                    ¿Quieres reservar una cita con un taller mecánico en tu zona? ¿Te gustaría reservar una cita para
                    revisar tu automovil,
        ...
        <div class="flex justify-around flex-row w-full pt-20 align-middle">
            ...
            <div class="flex pr-32 w-1/2 text-left flex-col gap-10">
                ...
                <p>
                    ...
                    1 y gestiona tus citas desde cualquier lugar. Modifica o cancela tus reservas sin necesidad de
                    llamar por teléfono.
                </p>
            </div>
        ...
        <div class="flex justify-around flex-row w-full pt-20 align-middle">
            <div class="flex pl-32 w-1/2 text-left flex-col gap-6">
                ...
                <p>
                    Echa un vistazo al perfil del negocio y conoce las opiniones de otros usuarios gracias a las reseñas
                    verificadas. También puedes ver los resultados de su trabajo.
                </p>
                <p>
                    Ahorra tiempo y deja el estrés a otro. Con B&O, reservar tu próxima cita a un taller mecáncio
                    cercano (o no), es gratis, fácil y rápido.
                </p>
            </div>
            <div class="flex justify-center w-10/12">
                <img src="{{ asset('img/coche1.jpg') }}" alt="esp" class="w-3/6 h-4/7">
            </div>
